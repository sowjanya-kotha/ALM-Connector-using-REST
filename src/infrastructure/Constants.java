...
private Constants() {}
   public static final String HOST = "http://52.40.188.109";
   public static final String PORT = "8080";

   public static final String USERNAME = "admin";
   public static final String PASSWORD = "someAdmin1";

   public static final String DOMAIN = "ABC";
   public static final String PROJECT = "Temp";
